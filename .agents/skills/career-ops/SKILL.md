...
user_invocable: true
user-invocable: true
argument-hint: "[scan | discover | deep | pdf | latex | latex-tex | cover | email | add | expand | offer | offers | apply | batch | tracker | agent-inbox | pipeline | outreach | training | project | interview-prep | interview | interview/plan | interview/practice | interview/debrief | interview-redflag | patterns | offer-prep | titles | upskill | followup | reply-watch | outcome | update]"
license: MIT
---
...
Applies to: `auto-pipeline`, `offer`, `offers`, `pdf`, `outreach`, `apply`, `pipeline`, `scan`, `batch`
