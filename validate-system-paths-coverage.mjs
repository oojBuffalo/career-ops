...
if (process.argv.includes('--self-test')) {
  ...
  assert(covered('providers/greenhouse.mjs') === true, 'providers/greenhouse.mjs must be covered (dir prefix match)');

  // Test sibling mismatch (strict prefix match)
  assert(covered('providers-sibling/greenhouse.mjs') === false, 'providers-sibling/greenhouse.mjs must NOT be covered');
