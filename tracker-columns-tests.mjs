...
| # | Date | Company | Role | Location | Score | Status | PDF | Report | Notes |
|---|------|---------|------|----------|-------|--------|-----|--------|-------|
| 1 | 2026-01-01 | Acme | Engineer | Remote | — | Sent 2026-01-02 | ✅ | — | backfilled, no eval |
| 2 | 2026-01-03 | Globex | Manager | Berlin | 4.5/5 | DUP of #1 | ❌ | — | keep me |
`;
  ...
  if (globex[7] === 'Discarded' && globex[6] === '4.5/5'
      && globex[10].includes('DUP of #1') && globex[10].includes('keep me')) {
    pass('normalize-statuses: DUP provenance lands in the Notes column on 10-col tracker');
  } else {
    fail(`normalize-statuses DUP row on 10-col tracker: ${rowOf('Globex')}\n${res.stdout}`);
  }
  rmSync(sb.dir, { recursive: true, force: true });
}
