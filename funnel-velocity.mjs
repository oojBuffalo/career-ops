...
export function computeWaiting(rows, timelines, benchmarks, todayStr) {
  ...
  for (const row of rows) {
    ...
    // status carrying a date, the "Sent" alias, markdown-bold "**Applied**")
...
function selfTest() {
  ...
  // carrying a date, the "Sent" alias, and markdown-bold "**Applied**"
  ...
  const noncanonTracker = [
    ...
    '| 4 | 2026-06-01 | AliasCo | Role | 4.0/5 | Sent | ❌ | - | Applied 2026-07-01 |',
