 ...
 *
 * Assembles the context sections from _shared.md, offer.md, cv.md, and
 ...
 * @param {string} opts.offerContent   - Raw offer.md content (evaluation mode).
...
export function buildBudgetedPrompt(opts) {
  ...
  const sectionDefs = [
    ...
    { name: 'offer.md', content: offerContent, compressible: false },
...
function assembleContext(sections) {
  const labels = {
    ...
    'offer.md':    'EVALUATION MODE (offer.md)',
