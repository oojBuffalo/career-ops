...
It is NOT:
- `outreach`: short LinkedIn / chat-style outreach.
...
4. **LinkedIn message to the recruiter or hiring manager** as last resort —
   hand off to `outreach` mode for the short-form version of the same
   content.
...
- Keep the subject line in the same language as the body (English).
