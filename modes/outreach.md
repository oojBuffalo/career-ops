# Mode: outreach -- Outreach messages
...
- **Greeting** — a single ultra-short first-touch message for platforms with a hard
  character budget (job-board chat, a cold-email opener). No
  contact discovery. See **Greeting variant** at the end of this file.

**Pick the variant:** use **Greeting** when the user says "greeting" /
"cold opener", names a chat-style platform, or asks for a very
...
character budget — job-board chat boxes, or the first line
...
4. **Compose ONE message within the character budget.**
   ...
   - **Language:** write in English. Character count applies to the final text.
