...
- Suggest the user run `/career-ops outreach {company}` to find the right person first
...
> - Trying a different contact via `/career-ops outreach`
...
**To:** {email or "No contact found — run `/career-ops outreach` first"}
